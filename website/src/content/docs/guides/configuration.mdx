...
| `registry_owner` | `None` | Override for the Hugging Face registry owner. `None` uses the upstream `itextresearch` org; only the owner segment of each model repo id changes. |
