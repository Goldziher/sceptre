...
(``easyocr-tools``, candle-based); see ADR 0008. This module exists so the export can
...
def main() -> None:
    ...
    print(
        "easyocr_rs_tools.export: model export not yet implemented — this is the "
        ...
        "Rust `easyocr-tools` crate (see ADR 0008).",
        file=sys.stderr,
    )
    sys.exit(1)
