...
- Source: the first-party `xberg-io/sceptre-*` ONNX repos on Hugging Face (Apache-2.0, dynamic-width), exported from EasyOCR's weights by `sceptre_rs_tools` (ADR 0025): `craft_mlt_25k` + `english_g2`, `latin_g2`, `zh_sim_g2`, `japanese_g2`, `korean_g2`, `cyrillic_g2`, `telugu_g2`, `kannada_g2`.
